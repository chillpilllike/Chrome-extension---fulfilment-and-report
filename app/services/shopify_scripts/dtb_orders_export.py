...
DESTS = [
    {
        "name": "gofinch-newaud",
        "shop": "gofinch-newaud.myshopify.com",
        "auth": "oauth_expiring_offline",  # required
        "client_id": "3b80d3adb0700f351ca60e6fe88d8a12",
        "client_secret": os.getenv("SHOPIFY_DTB_CLIENT_SECRET", ""),
...
ASSIGN_TO_GENERIC_CUSTOMER = True
GENERIC_CUSTOMER_EMAIL = "am-it@outlook.com"
GENERIC_CUSTOMER_FIRST_NAME = "Amit"
GENERIC_CUSTOMER_LAST_NAME = "Soni"


GENERIC_CUSTOMER_PHONE = "+918800128087"  # Generic customer phone (E.164 preferred)
