  ...
  return <Card className="shopify-title-review">
    ...
    <CardContent className="grid gap-4">
      {rules && <div className="form-fieldset grid gap-3">
        ...
        <p className="text-xs text-muted-foreground">Remove the product’s Brand and the keywords below, then keep up to 6 words. SKU uses the full Odoo Internal Reference. This takes priority over typed-title mode.</p>
