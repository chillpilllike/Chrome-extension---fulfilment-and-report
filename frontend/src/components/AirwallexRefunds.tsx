...
export function AirwallexRefunds({stores,storeId,api}:Props) {
 ...
 async function run(label:string, fn:()=>Promise<void>) {
  ...
  try{await fn()}catch(e){setError(errorMessage(e))}finally{actionLock.current=false;setBusy('')}
 }
